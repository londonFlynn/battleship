...
#login {float: right; background-color: #fff; margin: 25px; border: 10px solid white;}
#homelink {float: left; font-size: 38px; margin: 25px;}
#dockPreview{position: absolute; bottom: 0; right: 0; margin: 35px;}
#multiplayerPreview{position: absolute; bottom: 0; left: 0; margin: 35px;}
...
<body>
    ...
    <footer id='preview'>
      <div id='multiplayerPreview' class='gameplaySection'>
          ...
          <ul>
              <li><p>Connect with random player</p></li>
      ...
      <div id='dockPreview' class='gameplaySection'>
          ...
          <ul>
              ...
              <li><p>And other things that I can't come up w/ right now</p></li>
          </ul>
      </div>
    </footer>
</body>
